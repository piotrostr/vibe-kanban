-- Add 'slashcommand' to execution_process run_reason CHECK constraint
...
CREATE TABLE execution_processes_new (
    ...
    run_reason TEXT NOT NULL
                       CHECK (run_reason IN ('setupscript','codingagent','devserver','cleanupscript','quickcommand','slashcommand')),
