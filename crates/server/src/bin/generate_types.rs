...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::commander_session::CommanderSession::decl(),
        db::models::commander_session::CreateCommanderSession::decl(),
        ...
        db::models::merge::ChecksStatus::decl(),
        ...
        services::services::linear::LinearUser::decl(),
        ...
        server::routes::task_attempts::pr::BindPrByNumberRequest::decl(),
        server::routes::task_attempts::pr::BindPrError::decl(),
